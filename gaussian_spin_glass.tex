...
\caption{A simple example of a 2D lattice of 4x4 spins, where the two groups of blocks are marked with back and white squares. Here the spin orientation in block 1 and 4 can be evaluated in parallel while 2 and 3 are held still and vice-versa.}
\label{fig:frustration}
\end{figure}
