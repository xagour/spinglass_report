...
In Fig. \ref{fig:E_2D_large} and \ref{fig:E_3D_large} we can see the square of the domain wall energy in two and three
...
\centering
  ...
  \end{tabular}
  \caption{The value of the stiffness exponent obtained by least square fit from the two best (lowest) system sizes $L=4,8$ in 2D and 3D.}
\end{table}
